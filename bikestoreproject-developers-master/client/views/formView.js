...
var AppView = Bb.View.extend({
  ...
  checkFields: function () {
    ...
    var priceQtyObject = {price:this.newPriceField.val(), quantity:this.newQuantityField.val()}
    var result = checkValues(priceQtyObject)
    if(result.price) {
      alert(result.price.msg)
      return false
    }
    if(result.quantity) {
      alert(result.quantity.msg)
      return false
    }
    return true
  },
